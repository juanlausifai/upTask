...
const tareasFinalizada=document.querySelector('.listado-finalizado');

if (tareasFinalizada) {
    tareasFinalizada.addEventListener('click',(e)=>{
            ...
            if (idUsuarioLi!==inputIdUsuario) {
              ...
              .then(function(respuesta){
                  if(respuesta.status===200){
                      functionPasarTareaEnProceso(parrafoText, idTarea,nombreEncargado,fechaVencimiento,idUsuarioLi);
                      li.remove();
...
function functionPasarTareaEnProceso(parrafoText, id,nombreEncargado,fechaVencimiento,idUsuarioLi) {
...
export default tareasFinalizada;